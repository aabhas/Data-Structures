...
class KDTree
{
    ...
    private:
		...
		//helper functions
		int dist(const Point<Dim> &x, const Point<Dim> &y) const;				
		void buildKDTree(int l, int r, int dim);
		void select(int left, int right, int mid, int dimension);
		int partition(int left, int right, int mean, int dimension);
		//void findNearestNeighbor(const Point<Dim> &query, Point<Dim> &currBest, int left, int right, int dim)const;
		Point<Dim> findNearestNeighbor(int left, int right, const Point<Dim> & query, Point<Dim> & curBest, int dim) const;
		//void findNearestNeighbor(int left, int right, const Point<Dim> & query, const Point<Dim> & curBest, int dim) const;
};
